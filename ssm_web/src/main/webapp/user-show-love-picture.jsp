...
<div class="page-wraper">
    ...
    <main class="page-content">
        ...
        <div class="page-head page-head_light" style="background-image: url('${pageContext.request.contextPath}/assets/img/cat-contain.jpg');">
            <div class="container">
                <div class="page-head__breadcrumb">
                    <a href="index.jsp"><i class="icon-xs icon-left flaticon-left-arrow-sign"></i>Back to home</a>
                </div>
                <h1 class="page-head__title">Category: Picture</h1>
            </div>
        </div>
        ...
        <section class="section news-primary">
            <div class="container">
                ...
                <div class="news-grid flex-row row columns-3" id="picture_main">
                    <c:forEach items="${pictureLoveList}" var="pictureLove">
                        <div class="new-item col-md-6 col-lg-4">
                            <div class="new-item__wrap">
                                <div class="new-item__image">
                                    <a href="#"><img src="http://localhost:8080/ssm_web/${pictureLove.picture_path}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
