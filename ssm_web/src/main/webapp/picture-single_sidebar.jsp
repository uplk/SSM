    ...
    <main class="page-content">
        ...
        <div class="page-head post-head">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <h1 class="page-head__title page-head__title_full" id="picture_title"></h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="post__tags">
                                            <h2 class="h4">Tags</h2>
                                            <div class="tag-cloud" id="picture_label" >
                                    ...
                                    <form class="comment-form">
                                        ...
                                        <div class="row form-group form-row">
                                            <div class="col-md-4 form-col">
                                                ...
                                                <input id="addLove" type="submit" class="btn btn-primary btn-submit animate form-control" value="Love" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script type="text/javascript">
    var picture_id = getQueryVariable("picture_id");
    var picture_path = getQueryVariable("picture_path");
    var picture_label = getQueryVariable("picture_label");
    var picture_title = getQueryVariable("picture_title");
    var picture_content = $("#commentText").val();

    $(document).ready(function(){
        
        $('#hide').html(
            '<input type="hidden" value='+picture_id+ ' name="hide_picture_id" id="hide_picture_id"  />' +
            '<input type="hidden" value='+picture_path+ ' name="hide_picture_path" id="hide_picture_path"   />' +
            '<input type="hidden" value='+picture_label+ ' name="hide_picture_label" id="hide_picture_label"   />' +
            '<input type="hidden" value='+picture_title+ ' name="hide_picture_title" id="hide_picture_title"  />' +
            '<input type="hidden" value='+picture_content+ ' name="hide_picture_content" id="hide_picture_content"  />'

        )
        var imgTxt = "";
        imgTxt += "<img src=";
        imgTxt += $('#hide_picture_path').val();
        imgTxt += " '/>";
        $("#img").html(imgTxt);
        ...
        //     labelTxt += "</span>";
        // }
        $("#picture_label").html($('#hide_picture_label').val());

        $('#picture_title').html($('#hide_picture_title').val());
        ...
        $.ajax({
            ...
            dataType:"json",
            url:"${pageContext.request.contextPath}/picture/findContent.do?pictureID="+$('#hide_picture_id').val(),
            success: function (data) {
                ...
                for(var i=0; i<data.length; i++){
                    contentTxt += '<div class="comment__content">' +
                        ...
                        '<div class="comment__text" id="picture_content">'+data[i].picture_content+'</div>'+
                        '</div>';
    ...
    function content(){
        $.ajax({
            ...
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            dataType:"json",
            url:"${pageContext.request.contextPath}/picture/addContent.do?picture_id="+picture_id+"&picture_content="+picture_content+"&picture_path="+picture_path + "&picture_label="+picture_label +"&picture_title="+picture_title,
        });
    }
    $(function () {
        $("#addLove").on("click", function(){
            ...
            $.ajax({
                ...
                type:"post",
                dataType: "text",
                url:"${pageContext.request.contextPath}/picture/addLove.do?picture_id="+$('#hide_picture_id').val(),
                success:function (data) {
                    if(data == "success"){
                    }else if(data == "error"){
