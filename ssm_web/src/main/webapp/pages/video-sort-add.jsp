...
<head>
    ...
    <title>AdminLTE 3 | Video Sort Add</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<div class="wrapper">
    ...
    <div class="form-group content-wrapper" style="background: url(${pageContext.request.contextPath}/assets/img/new6.jpg); background-size:100% 100%;">
        <form name="picture_sort_add" action="${pageContext.request.contextPath}/video/addSort.do" method="post">
            <label for="picture_sort" class="col-sm-1 control-label">分类</label>
            <div class="col-md-2 col-lg-4">
                <input id="picture_sort" class="form-control" name="video_sort"/>
            </div>
            <div class="col-md-2 col-lg-4">
