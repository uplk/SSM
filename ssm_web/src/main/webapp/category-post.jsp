							...
							<div class="news-list">
								...
								<div class="new-item">
									<div class="new-item__wrap">
										<div class="row">
											<div class="new-item__image col-md-6">
												<a href="post-single_sidebar.jsp"><img src="assets/img/new28.jpg" alt=""></a>
											</div>
											<div class="new-item__info col-md-6">
												<div class="h3 new-item__title"><a href="post-single_sidebar.jsp">Night Creams Will Help Your Skin To Relax Become Younger</a></div>
												<ul class="new-item__meta d-flex align-items-center">
													<li class="new-item__meta-author">
								...
								<div class="new-item">
									<div class="new-item__wrap">
										<div class="row">
											<div class="new-item__image col-md-6">
												<a href="post-single_sidebar.jsp"><img src="assets/img/new29.jpg" alt=""></a>
											</div>
											<div class="new-item__info col-md-6">
												<div class="h3 new-item__title"><a href="post-single_sidebar.jsp">Lasik Eye Surgery Are You Ready</a></div>
												<ul class="new-item__meta d-flex align-items-center">
													<li class="new-item__meta-author">
								...
								<div class="new-item">
									<div class="new-item__wrap">
										<div class="row">
											...
											<div class="new-item__info col-md-6">
												<div class="h3 new-item__title"><a href="post-single_sidebar.jsp">Having Your Breasts</a></div>
												<ul class="new-item__meta d-flex align-items-center">
													<li class="new-item__meta-author">
								...
								<div class="new-item last">
									<div class="new-item__wrap">
										<div class="row">
											<div class="new-item__image col-md-6">
												<a href="post-single_sidebar.jsp"><img src="assets/img/new31.jpg" alt=""></a>
											</div>
											<div class="new-item__info col-md-6">
												<div class="h3 new-item__title"><a href="post-single_sidebar.jsp">Natural Beauty From Natural Ingredients</a></div>
												<ul class="new-item__meta d-flex align-items-center">
													<li class="new-item__meta-author">
								...
								<ul class="widget-post-list">
									<li class="widget-post">
										<div class="widget-post__img">
											<a href="post-single_sidebar.jsp"><img src="assets/img/small-post1.jpg" alt=""></a>
										</div>
									...
									<li class="widget-post">
										<div class="widget-post__img">
											<a href="post-single_sidebar.jsp"><img src="assets/img/small-post10.jpg" alt=""></a>
										</div>
										<div class="widget-post__content">
											<div class="cat-title"><a href="category-post.jsp">Fashion</a></div>
