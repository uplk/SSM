...
<body>
	...
	<div class="page-wraper">
		...
		<main class="page-content">
			...
			<div class="page-head post-head text-center" style="background-image: url('assets/img/single-contain2.jpg');">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-10">
							<h1 class="page-head__title page-head__title_full">Dream Interpretation Common Symbols And Their Meanings</h1>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-10">
							<article class="post post-full">
								...
								<div class="post__content post__content_full">
									...
									<div class="gallery gallery-columns-2">
										<figure class="gallery-item">
											<div class="gallery-icon landscape">
												<img src="assets/img/post-gallery3.jpg" alt="" class="medium-img">
											</div>
										</figure>
										<figure class="gallery-item">
											<div class="gallery-icon landscape">
												<img src="assets/img/post-gallery4.jpg" alt="" class="medium-img">
											</div>
										</figure>
									</div>

									<iframe src="https://player.vimeo.com/video/125829109?title=0&byline=0&portrait=0" width="990" height="550" allowfullscreen></iframe>
