...
<body>
	<!-- <div id="page-preloader"><span class="spinner static pulse"></span></div> -->
	<div class="page-wraper">
		...
		<main class="page-content">
							...
							<div class="news-list">
								...
								<div class="new-item">
									<div class="new-item__wrap">
										<div class="row">
											<div class="new-item__image col-md-6">
												<a href="post-single_sidebar.jsp"><img src="assets/img/new2.jpg" alt=""></a>
											</div>
											<div class="new-item__info col-md-6">
								...
								<div class="new-item">
									<div class="new-item__wrap">
										<div class="row">
											<div class="new-item__image col-md-6">
												<a href="post-single_sidebar.jsp"><img src="assets/img/new3.jpg" alt=""></a>
											</div>
											<div class="new-item__info col-md-6">
								...
								<div class="new-item">
									<div class="new-item__wrap">
										<div class="row">
											<div class="new-item__image col-md-6">
												<a href="post-single_sidebar.jsp"><img src="assets/img/new4.jpg" alt=""></a>
											</div>
											<div class="new-item__info col-md-6">
								...
								<div class="new-item last">
									<div class="new-item__wrap">
										<div class="row">
											<div class="new-item__image col-md-6">
												<a href="post-single_sidebar.jsp"><img src="assets/img/new5.jpg" alt=""></a>
											</div>
											<div class="new-item__info col-md-6">
			...
			<section class="newsletter has-fill" style="background-image: url('assets/img/newslatter.jpg');">
				<div class="container">
